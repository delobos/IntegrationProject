...
def mcdollini_silo():
    print("\nYou make your way over to the silo, pushing past rows of grain. As you approach the left most silo you realize the screaming has stopped and the bird that was flying above is now perched on the roof stairng at you intently.")
...
def step_out_kill_lore2():
    ...
    print("You pull your sword from the creatures side as it lets our another loud screech. You raise the sword over your head and bring it down diagonally on its shoulder, where the crow begins to let our a gurgling sound before falling over lifeless.")
    print("You stand there momentarily looking at your defeated foe before snapping back into the moment and realizing you have lost sight of the fleeing crows. You climb a stack of boxes near the porch and get on the roof but to no avail. You can no longer see the fleeing crows.")
...
def escape_lore1ab():
    ...
    print("The biggest crow of the group also begins a dive towards you, gripping the sword tightly you thrust up as you are knocked down by this heavy weight crashing into you. Laying there for a few seconds you feel a wet warmth on your hands and chest")
    print("You push the dead crow off of you into the water, the others seeing you killing their leader flee in fear.")


def escape_lore1b():
    print("You grab a couple pillow cases and a blanket that you make to look like your shape and cover it with a blanket into the rowboat before you cut the line tying it in place, sending it downstream.")
...
def escape_lore_closet():
    ...
    print("Eventually you hear the tapping of the claws of the crow enter the room who you hear rummage throughout the room before stopping right in front of the closet door. It opens the closet door and lets out a loud caw as two other crows enter the room.")
    print("They overpower you and pry the stone from your hands leaving you injured on the floor of the closet.")


def escape_lore_hide():
...
def continue_lore():
    print("Tired and sore, you make your way back to your home, hopeful that you will bring your brother back.")
...
def hero_lore():
    ...
    while choice_loop_hero <= 0:
        ...
        if choice_hero == 'b':
            print("\n\nYou start to drift back to sleep, going back into that sweet dream of all you can eat meat pies \nzZzZ \nZz \nYour eyes open as you feel a strong kick to your side, that immediately curls you into a fetal position")
